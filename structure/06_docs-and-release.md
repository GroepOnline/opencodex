...
- 선택한 방식: GitHub Actions Pages + custom domain `opencodex.chefgroep.online`, Cloudflare proxied CNAME to `groeponline.github.io`, root-relative assets. `ocx.chefgroep.online` stays the GUI.
