...
export const FREE_PROVIDER_ACCESS_GROUPS = {
  ...
  "recurring-credit": ["bytez", "nous-research", "wandb-inference", "aelius"],
  "signup-credit": [
    "agentrouter",
    "ai21",
    "baichuan",
...
type ConnectableOverride = Partial<
  Omit<FreeDirectoryProvider, "id" | "accessGroups">
>;
...
const openAi = (
  baseUrl: string,
  dashboardUrl: string,
  extra: Partial<ConnectableOverride> = {},
): ConnectableOverride => ({
  baseUrl,
  dashboardUrl,
  adapter: "openai-chat",
...
const CONNECTABLE: Record<string, ConnectableOverride> = {
  kiro: {
    ...
    documentationUrl: "https://kiro.dev/docs/cli/authentication/",
    lastVerified: LAST_VERIFIED,
    discovery: "static",
    liveModels: false,
  },
  aihorde: openAi("https://oai.aihorde.net/v1", "https://aihorde.net", {
    modelsUrl: "https://oai.aihorde.net/v1/models",
  }),
  "arcee-ai": openAi(
    "https://conductor.arcee.ai/v1",
    "https://conductor.arcee.ai",
    { verification: "official", documentationUrl: "https://docs.arcee.ai/" },
  ),
  cerebras: openAi(
  ...
  "github-models": openAi(
    ...
    "https://github.com/settings/tokens",
    {
      ...
      discovery: "static",
      liveModels: false,
      models: ["openai/gpt-4.1", "meta/llama-4-scout-17b-16e-instruct"],
    },
  ),
  groq: openAi(
    ...
    "https://console.groq.com/keys",
    {
      supportLevel: "supported",
      verification: "official",
      documentationUrl: "https://console.groq.com/docs/api-reference#models",
    },
  ),
  hackclub: openAi(
  ...
  huggingface: openAi(
    ...
    "https://huggingface.co/settings/tokens",
    {
      supportLevel: "supported",
      verification: "official",
      documentationUrl: "https://huggingface.co/docs/inference-providers/index",
  ...
  inferx: openAi(
    ...
    {
      verification: "primary",
      documentationUrl: "https://inferx.net/pricing/endpoints",
      modelsUrl: "https://model.inferx.net/endpoints/v1/models",
      note: "Free-plan candidate with selected 100%-discount models and provider-stated ZDR. Processing residency is not pinned in the public free-tier material; keep non-public traffic disabled until policy evidence is stronger.",
    },
  ),
  ...
  morph: openAi("https://api.morphllm.com/v1", "https://morphllm.com", {
    verification: "official",
    documentationUrl: "https://docs.morphllm.com/api-reference/introduction",
  }),
  "ollama-cloud": openAi(
    "https://ollama.com/v1",
  ...
  opencode: openAi("https://opencode.ai/zen/v1", "https://opencode.ai/auth", {
    supportLevel: "supported",
    verification: "official",
  ...
  entrim: openAi("https://api.entrim.ai/v1", "https://entrim.ai", {
    verification: "primary",
    lastVerified: "2026-08-28",
    documentationUrl: "https://www.entrim.ai/llm-inference/",
    discovery: "live",
    liveModels: true,
    note: "$25 signup credit. EU-operated inference; provider states prompts/outputs are not retained after completion and are not used for training.",
  }),
  freeinference: openAi(
    "https://freeinference.org/v1",
    "https://freeinference.org",
    {
      verification: "primary",
      lastVerified: "2026-08-28",
      documentationUrl: "https://doc.freeinference.org/quickstart",
      modelsUrl: "https://freeinference.org/v1/models",
      note: "Free research/community endpoint. Provider states all prompts and responses are logged for research and anonymized derivatives may be open-sourced; public-only traffic.",
    },
  ),
  flexai: openAi("https://api.flex.ai/v1", "https://flex.ai/token-factory", {
    verification: "official",
    lastVerified: "2026-08-28",
  ...
  "wandb-inference": openAi(
    ...
    "https://wandb.ai/settings",
    {
      verification: "official",
      lastVerified: "2026-08-28",
      documentationUrl: "https://docs.wandb.ai/inference/api-reference",
      modelsUrl: "https://api.inference.wandb.ai/v1/models",
      note: "Serverless Inference uses W&B API keys and optional OpenAI-Project attribution. Included/free-plan inference credits are account-dependent; verify retention before private traffic.",
    },
  ),
  "simplellm-eu": openAi(
    ...
    "https://simplellm.eu",
    {
      verification: "primary",
      lastVerified: "2026-08-28",
      documentationUrl: "https://simplellm.eu/",
      discovery: "live",
      liveModels: true,
      note: "EU-hosted OpenAI-compatible service with permanent free-tier models and published rate limits. EU residency does not by itself prove zero retention; verify retention before restricted traffic.",
    },
  ),
  "ai-vps-cz": openAi("https://ai.vps.cz/api/v1", "https://ai.vps.cz", {
    verification: "primary",
    lastVerified: "2026-08-28",
    documentationUrl: "https://ai.vps.cz/",
    discovery: "static",
    liveModels: false,
    models: ["llama-3.1-8b"],
    note: "$10 signup credit with no card advertised. Hosted catalog is currently small; privacy/data-residency posture needs verification before non-public traffic.",
  }),
  ...
  tokenharbor: openAi(
    ...
    "https://tokenharbor.ai/dashboard",
    {
      supportLevel: "supported",
      verification: "official",
      documentationUrl: "https://status.tokenharbor.ai/docs/api/models",
      modelsUrl: "https://tokenharbor.ai/v1/models",
      note: "One Universal Key exposes the live multi-model catalog. Explicit :free routes never charge wallet balance, but permanent free routes may retain prompts/responses after account opt-in; keep free traffic public-only unless policy changes.",
    },
  ),
  "empero-free": openAi(
    "https://free.empero.org/v1",
    "https://free.empero.org",
    {
      keyOptional: true,
  ...
  optracloud: openAi(
    "https://api.optracloud.com/v1",
    "https://optracloud.com",
    {
      verification: "primary",
  ...
  sambanova: openAi(
    ...
    "https://cloud.sambanova.ai/apis",
    {
      ...
      verification: "official",
      documentationUrl:
        "https://docs.sambanova.ai/cloud/docs/api-reference/models",
    },
  ),
  sparkdesk: openAi(
    "https://spark-api-open.xf-yun.com/v1",
  ...
  aion: openAi("https://api.aionlabs.ai/v1", "https://aionlabs.ai", {
  ...
  "kilo-gateway": openAi("https://api.kilo.ai/api/gateway", "https://kilo.ai", {
  ...
  requesty: openAi("https://router.requesty.ai/v1", "https://app.requesty.ai", {
  ...
  bytez: openAi(
    ...
    "https://bytez.com",
    {
      ...
      documentationUrl: "https://docs.bytez.com/",
      discovery: "static",
      liveModels: false,
      models: [
      ...
      note: "The recurring-credit classification is retained from the requested catalog, but the current reset terms could not be independently verified.",
    },
  ),
  ...
  agentrouter: {
    ...
    dashboardUrl: "https://agentrouter.org",
    adapter: "anthropic",
    authKind: "key",
    supportLevel: "experimental",
    verification: "primary",
  ...
  ai21: openAi(
    ...
    "https://studio.ai21.com/account/api-key",
    {
      supportLevel: "supported",
      verification: "official",
      documentationUrl: "https://docs.ai21.com/reference/models",
    },
  ),
  baichuan: openAi(
  ...
  fireworks: openAi(
    ...
    "https://fireworks.ai/account/api-keys",
    {
      supportLevel: "supported",
      verification: "official",
      documentationUrl: "https://docs.fireworks.ai/api-reference/list-models",
      modelsUrl:
        "https://api.fireworks.ai/v1/accounts/fireworks/models?filter=supports_serverless=true",
    },
  ),
  "freemodel-dev": openAi(
  ...
  monsterapi: openAi("https://api.monsterapi.ai/v1", "https://monsterapi.ai", {
    verification: "official",
  }),
  nebius: openAi(
  ...
  nvidia: openAi(
    ...
    "https://build.nvidia.com",
    {
      supportLevel: "supported",
      verification: "official",
      documentationUrl: "https://docs.api.nvidia.com/nim/reference/llm-apis",
    },
  ),
  ...
  together: openAi(
    ...
    "https://api.together.xyz/settings/api-keys",
    {
      supportLevel: "supported",
      verification: "official",
      documentationUrl: "https://docs.together.ai/reference/models-1",
    },
  ),
  vertex: {
    ...
    note: "Vertex accepts an express-mode API key here. ADC users can instead configure project and location through the existing Google Vertex provider.",
  },
};
...
const LABELS: Record<string, string> = {
  ...
  flexai: "FlexAI Token Factory",
  "wandb-inference": "W&B Serverless Inference",
  "simplellm-eu": "SimpleLLM.eu",
  "ai-vps-cz": "ai.vps.cz",
  aelius: "Aelius",
  tokenharbor: "Token Harbor",
  "empero-free": "Empero Free",
  ai21: "AI21",
  baichuan: "Baichuan",
  deepinfra: "DeepInfra",
  deepseek: "DeepSeek",
...
const referenceNote =
  "Reference entry only: no safe documented API integration is enabled. Configure it manually only with provider documentation; consumer-web cookies and anti-bot bypasses are intentionally unsupported.";

export const FREE_PROVIDER_DIRECTORY: readonly FreeDirectoryProvider[] =
  Object.values(FREE_PROVIDER_ACCESS_GROUPS)
    .flat()
    .filter((id, index, ids) => ids.indexOf(id) === index)
    .map((id) => {
      const accessGroups = (
        Object.entries(FREE_PROVIDER_ACCESS_GROUPS) as [
          ProviderAccessGroup,
          readonly string[],
        ][]
      )
