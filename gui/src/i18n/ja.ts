...
export const ja: Record<TKey, string> = {
  ...
  "claudeDesktop.subtitle": "各 Claude モデルファミリーをポート {port} の利用可能なモデルにルーティングします。",
  ...
  "claudeDesktop.importReady": "JSON をインポートしました。ドラフトを確認してから保存して適用してください。",
  "claudeDesktop.importedAnnounce": "プロファイル JSON をインポートしました。未保存の変更を確認できます。",
  "claudeDesktop.importInvalid": "選択したファイルは有効なプロファイルではありません。",
  ...
  "claudeDesktop.emptyHint": "プロバイダーを追加または有効化してから、戻って Claude Desktop のルートを割り当ててください。",
  ...
  "claudeDesktop.modelCountOne": "{count} 個のモデル",
  "claudeDesktop.modelCountMany": "{count} 個のモデル",
  ...
  "claudeDesktop.contextM": "コンテキスト {n}M",
  "claudeDesktop.contextK": "コンテキスト {n}k",
  "claudeDesktop.alias": "エイリアス",
  "claudeDesktop.useAsDefault": "{family} のデフォルトとして使用",
  ...
  "claudeDesktop.health.lastRequest": "最後のリクエスト",
