...
export const ko: Record<TKey, string> = {
  ...
  "dash.suppliers": "프로바이더",
  "dash.refresh": "새로고침",
  "dash.refreshAll": "모두 새로고침",
  "dash.retry": "다시 시도",
  "dash.fresh": "갱신 · {time}",
  "dash.noContactSince": "{time} 이후 응답 없음",
  "dash.modelsCount": "{count}개 모델",
  "dash.showModels": "모델 보기",
  "dash.hideModels": "모델 숨기기",
  "dash.stamp.ready": "준비됨",
  "dash.stamp.busy": "동작중",
  "dash.stamp.error": "오류",
  "dash.stamp.idle": "대기",
  "dash.settingsSection": "설정",
  "dash.emptyKitchen": "아직 모델이 없습니다.",
  "dash.providerDisabled": "비활성화됨",
  ...
  "prov.accounts": "계정 ({n})",
  "prov.quotaRefresh": "사용량 새로 고침",
  "prov.quotaRefreshing": "새로 고치는 중…",
  "prov.quotaRefreshFailed": "새로 고침 실패 — 마지막 데이터 표시 중",
  "prov.quotaRefreshAria": "{name} 사용량 새로 고침",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "shell.navTraffic": "트래픽",
  "shell.navSystem": "시스템",
  "shell.navAria": "주 탐색",
  "shell.offlineBanner": "프록시 오프라인. Codex와 Cursor가 라우팅할 수 없습니다.",
  "mod.subtitle": "카탈로그, 라우팅, 서브 에이전트 위임.",
  "mod.tablistAria": "모델 섹션",
  "sys.manage": "관리",
  "sys.subtitle": "프록시 자체: 상태, 버전, 저장소, 관리.",
  "sys.proxy": "프록시",
  "sys.uptime": "{uptime} 가동",
  "sys.updateTo": "{version}(으)로 업데이트",
  "sys.upToDate": "최신 버전을 사용 중입니다.",
  "sys.updateCheckFailed": "업데이트 확인 실패",
  "sys.updateStartFailed": "업데이트 시작 실패",
  "sys.updateRunning": "업데이트 실행 중입니다. 프록시가 곧 자동으로 재시작됩니다.",
  "sys.catalog": "모델 카탈로그",
  "sys.catalogDesc": "동기화는 각 공급자에서 최신 모델을 가져옵니다.",
  "sys.syncFailed": "동기화 실패",
  "sys.storage": "저장소",
  "sys.storageValue": "{size} · 파일 {count}개",
  "sys.apiEndpoint": "API 엔드포인트",
  "sys.copy": "복사",
  "sys.copied": "복사됨",
  "sys.codexAuthDesc": "openai 공급자용 ChatGPT 계정 풀",
  "sys.claudeCodeDesc": "Claude 통합 및 에이전트 주입",
  "sys.dangerZone": "위험 구역",
  "sys.stopDesc": "프록시를 완전히 중지합니다. Codex와 Cursor의 연결이 끊깁니다.",
  "sys.stopConfirmTitle": "프록시를 중지할까요?",
  "sys.stopConfirmDesc": "Codex와 Cursor의 연결이 끊깁니다.",
  "sys.keepRunning": "계속 실행",
  "vk.subtitle": "프록시를 통과하는 모든 것: 모든 요청은 영수증입니다.",
  "vk.statsAria": "트래픽 수치",
  "vk.tokens30d": "토큰 (30일)",
  "vk.requestsToday": "오늘 요청",
  "vk.requests30d": "요청 (30일)",
  "vk.filterAria": "공급자별 필터",
  "vk.all": "전체",
  "vk.pause": "일시정지",
  "vk.follow": "실시간 보기",
  "vk.loadFailed": "트래픽을 불러올 수 없습니다. 마지막으로 확인된 영수증이 유지됩니다.",
  "vk.empty": "오늘 아직 트래픽이 없습니다.",
  "vk.showAnalysis": "전체 분석",
  "vk.hideAnalysis": "분석 숨기기",
  "vk.stampDone": "완료",
  "vk.stampError": "오류",
  "vk.stampBusy": "진행 중",
