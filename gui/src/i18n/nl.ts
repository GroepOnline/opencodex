...
export const nlOverrides: Partial<Record<TKey, string>> = {
  ...
  "models.active": "{active}/{total} zichtbaar",
  "models.collapseAll": "Alles inklappen",
  "models.expandAll": "Alles uitklappen",
  "models.tipProvider": "Leverancier",
  "models.tipContext": "Context",
  "models.tipModalities": "Modaliteiten",
  "models.customEdit": "Bewerken",
  "models.customDelete": "Verwijderen",
  "models.customDeleteConfirm": "Model {name} verwijderen?",
  "models.workspace.description":
    "Zoek een model, bekijk de configuratie en kies wat je client toont.",
  "models.workspace.manageProviders": "Leveranciers beheren",
  "models.workspace.providerSettings": "Providerinstellingen",
  "models.workspace.search": "Zoek modellen of leveranciers…",
  "models.workspace.inspect": "Bekijk {model}",
  "models.workspace.unknown": "Niet opgegeven",
  "models.workspace.catalog": "Modelcatalogus",
  "models.workspace.model": "Model",
  "models.workspace.visibility": "In modelkiezer",
  "models.workspace.visibilityColumn": "Zichtbaar",
  ...
  "models.workspace.hidden": "Uitgesloten in je modelinstellingen",
  "models.workspace.noMatches": "Geen passende modellen",
  "models.workspace.clearSearch": "Zoekopdracht wissen",
  "models.workspace.advanced": "Modelinstellingen en geavanceerde opties",
  "models.workspace.back": "Terug naar modellen",
  "models.workspace.contextLimit": "Ingestelde contextlimiet",
  "models.workspace.catalogNotHealth":
    "Catalogusinformatie, geen live verbindingstest. Zichtbaarheid bewijst geen accounttoegang of welk model daadwerkelijk is geserveerd.",
  "models.workspace.chooseModel": "Selecteer een model",
  "models.workspace.chooseModelHint":
    "Vergelijk context en mogelijkheden, pas de zichtbaarheid aan of bewerk een eigen model.",
  ...
  "vk.modelColShare": "aandeel",
  "vk.modelColCost": "kosten",
  "vk.showOps": "Ops & gezondheid",
  "vk.hideOps": "Ops verbergen",
  ...
  "ops.cacheAria": "Responscache-statistieken",
  "ops.cacheHitRate": "hitratio",
  "ops.cacheEntries": "items (max {n})",
  "ops.cacheHits": "hits",
  ...
  // publieke landing
  "landing.nav.homeAria": "OpenCodex-startpagina",
  "landing.nav.primaryAria": "Hoofdnavigatie",
  ...
  "landing.terminal.routed": "✓ gerouteerd via {model} (quota {quota}%)",
  ...
  "landing.cta.docs": "Lees de docs",
  "landing.cta.dashboard": "Open het dashboard",
  "landing.footer.aria": "Footer",
  "landing.footer.license": "MIT-licentie",
  "landing.footer.note": "Een GroepOnline-project.",
};
