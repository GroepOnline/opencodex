...
const overrides: Partial<Record<TKey, string>> = {
  ...
  "startup.subtitle": "Check of de proxy na een reboot blijft lopen. Op deze host is dat de systemd-unit, niet een laptop-shim.",
  ...
  "startup.recoveryHint": "Gebruik de installers hierboven, of kopieer een commando. Op deze proxy-host is de systemd-unit de bescherming — niet ocx restore.",
