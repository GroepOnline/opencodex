...
export const de = {
  ...
  "dash.suppliers": "Anbieter",
  "dash.refresh": "Aktualisieren",
  "dash.refreshAll": "Alle aktualisieren",
  "dash.retry": "Erneut versuchen",
  "dash.fresh": "Frisch · {time}",
  "dash.noContactSince": "Kein Kontakt seit {time}",
  "dash.modelsCount": "{count} Modelle",
  "dash.showModels": "Modelle anzeigen",
  "dash.hideModels": "Modelle ausblenden",
  "dash.stamp.ready": "BEREIT",
  "dash.stamp.busy": "AKTIV",
  "dash.stamp.error": "FEHLER",
  "dash.stamp.idle": "STILL",
  "dash.settingsSection": "Einstellungen",
  "dash.emptyKitchen": "Noch keine Modelle.",
  "dash.providerDisabled": "Deaktiviert",
  ...
  "prov.quotaRefresh": "Nutzung aktualisieren",
  "prov.quotaRefreshing": "Aktualisiere…",
  "prov.quotaRefreshFailed": "Aktualisierung fehlgeschlagen — letzte bekannte Daten",
  "prov.quotaRefreshAria": "Nutzung für {name} aktualisieren",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "shell.navTraffic": "Verkehr",
  "shell.navSystem": "System",
  "shell.navAria": "Hauptnavigation",
  "shell.offlineBanner": "Proxy offline. Codex und Cursor können nicht routen.",
  "mod.subtitle": "Katalog, Routing und Delegation für Sub-Agents.",
  "mod.tablistAria": "Modellbereiche",
  "sys.manage": "Verwalten",
  "sys.subtitle": "Der Proxy selbst: Status, Version, Speicher und Verwaltung.",
  "sys.proxy": "Proxy",
  "sys.uptime": "{uptime} in Betrieb",
  "sys.updateTo": "Auf {version} aktualisieren",
  "sys.upToDate": "Du nutzt die neueste Version.",
  "sys.updateCheckFailed": "Update-Prüfung fehlgeschlagen",
  "sys.updateStartFailed": "Update konnte nicht gestartet werden",
  "sys.updateRunning": "Update läuft. Der Proxy startet sich gleich neu.",
  "sys.catalog": "Modellkatalog",
  "sys.catalogDesc": "Sync holt die neuesten Modelle von jedem Anbieter.",
  "sys.syncFailed": "Sync fehlgeschlagen",
  "sys.storage": "Speicher",
  "sys.storageValue": "{size} · {count} Dateien",
  "sys.apiEndpoint": "API-Endpunkt",
  "sys.copy": "Kopieren",
  "sys.copied": "Kopiert",
  "sys.codexAuthDesc": "ChatGPT-Konto-Pool für den openai-Anbieter",
  "sys.claudeCodeDesc": "Claude-Integration und Agent-Injektion",
  "sys.dangerZone": "Gefahrenzone",
  "sys.stopDesc": "Stoppt den Proxy vollständig. Codex und Cursor verlieren ihre Verbindung.",
  "sys.stopConfirmTitle": "Proxy stoppen?",
  "sys.stopConfirmDesc": "Codex und Cursor verlieren ihre Verbindung.",
  "sys.keepRunning": "Weiterlaufen lassen",
  "vk.subtitle": "Was durch den Proxy läuft: jede Anfrage ist ein Beleg.",
  "vk.statsAria": "Verkehrszahlen",
  "vk.tokens30d": "Tokens (30T)",
  "vk.requestsToday": "Anfragen heute",
  "vk.requests30d": "Anfragen (30T)",
  "vk.filterAria": "Nach Anbieter filtern",
  "vk.all": "Alle",
  "vk.pause": "Pausieren",
  "vk.follow": "Live folgen",
  "vk.loadFailed": "Verkehr kann nicht geladen werden. Die letzten bekannten Belege bleiben stehen.",
  "vk.empty": "Heute noch kein Verkehr.",
  "vk.showAnalysis": "Vollständige Analyse",
  "vk.hideAnalysis": "Analyse ausblenden",
  "vk.stampDone": "Fertig",
  "vk.stampError": "Fehler",
  "vk.stampBusy": "Läuft",
  "vk.detailError": "Fehler: {code}",
  "vk.detailInOut": "ein {in} · aus {out}",
  "vk.rowTokens": "{n} Tok",
  "vk.rowDuration": "{s}s",
