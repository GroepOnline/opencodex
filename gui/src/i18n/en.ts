...
export const en = {
  ...
  // per-provider fetch (dashboard supplier cards)
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "mod.subtitle": "Catalog, routing and delegation for sub-agents.",
  "mod.tablistAria": "Model sections",
  "sys.manage": "Manage",
  "sys.subtitle": "The proxy itself: status, version, storage and management.",
  "sys.proxy": "Proxy",
  "sys.uptime": "{uptime} in service",
  "sys.updateTo": "Update to {version}",
  "sys.upToDate": "You're on the latest version.",
  "sys.updateCheckFailed": "update check failed",
  "sys.updateStartFailed": "failed to start update",
  "sys.updateRunning": "Update running. The proxy will restart itself shortly.",
  "sys.catalog": "Model catalog",
  "sys.catalogDesc": "Sync fetches the latest models from every provider.",
  ...
  "sys.stopConfirmDesc": "Codex and Cursor lose their connection.",
  ...
  "vk.loadFailed": "Can't load traffic. The last known receipts stay put.",
