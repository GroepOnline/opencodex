...
export const en = {
  ...
  "pws.fetchModelsStatic": "Live discovery is off — showing the configured list ({count}).",
  "pws.fetchModelsPassthrough": "Passthrough providers have no upstream /models catalog.",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.healthSummary.expired": "{provider} {account}: the seat date has passed. Routing for this account is paused.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "oauthPool.title.googleAntigravity": "Antigravity account pool (experimental)",
  "oauthPool.enabledDesc.anthropic": "On 429 or 529, cools the account and hops. New sessions prefer usage under {threshold}% (5-hour bar).",
  "oauthPool.enabledDesc.cursor": "On 429 or 529, cools the account and hops. New sessions prefer usage under {threshold}%.",
  "oauthPool.enabledDesc.googleAntigravity": "On 429 or 529, cools the account and hops. New sessions prefer usage under {threshold}%.",
  "oauthPool.disabledDesc": "Uses only the active account until you turn the pool on.",
  "oauthPool.warning.anthropic": "Experimental and not battle-tested. Anthropic may restrict accounts that look like automated multi-account rotation. Same organization can share quota — pooling those accounts will not help. Keep this off unless you understand the risk.",
  "oauthPool.warning.cursor": "Experimental. Cursor may restrict accounts that look like automated rotation. Two seats on the same team plan often share quota — pooling those will not help.",
  "oauthPool.warning.googleAntigravity": "Experimental. Google may restrict accounts that look like automated rotation. Workspace-shared quota will not gain from pooling.",
  "oauthPool.needTwoAccounts": "Add at least two accounts before enabling the pool.",
  "oauthPool.threshold": "New-session usage threshold",
  "oauthPool.thresholdAria": "New-session usage threshold, percent",
  "oauthPool.thresholdHelp": "0 disables quota-based picking (affinity + active account only). Default 80.",
  ...
  "oauthPool.importKeyHelp": "Same Cursor login surface: OAuth for a browser account, or paste a user API key. The key stays on this machine and is never shown again.",
  "oauthPool.importKeySubmit": "Save key",
  "oauthPool.importKeyInvalid": "That value is not a Cursor JWT with a sub claim.",
  ...
  "claudeDesktop.savedApplied": "Saved on the proxy. Use Sync to this laptop to refresh Claude Desktop.",
  "claudeDesktop.savedAppliedAnnounce": "Saved on the proxy. Use Sync to this laptop to refresh Claude Desktop.",
  ...
  "claudeDesktop.syncLaptopAnnounce": "Opening the laptop sync helper. Allow it if the browser asks.",
  ...
  "ops.cacheConfig": "ttl {ttl}s · max {max} entries · body cap {cap} kB · persist: {persist}",
  "ops.persistOn": "on",
  "ops.persistOff": "off",
  "ops.cacheClear": "Clear cache",
  "ops.clearing": "Clearing…",
  "ops.cacheOff": "The response cache is off. Enable it with responseCache.enabled in the config.",
  ...
  "landing.hero.sub": "OpenCodex routes Claude, Gemini, Grok, DeepSeek and Ollama through one local endpoint, so your Codex CLI, app or SDK talks to every model without changing a line.",
  ...
  "landing.features.oneBody": "Point Codex at localhost once. Switch between Claude, Gemini, Grok, DeepSeek or a local Ollama model from the dashboard. No client reconfiguration, no SDK forks.",
  "landing.features.twoTitle": "Quota-aware routing",
  "landing.features.twoBody": "Rate limits and credit balances are tracked per account, live. When one key hits a wall, traffic moves to the next eligible account before your session stalls.",
  "landing.features.threeTitle": "Your keys stay home",
  "landing.features.threeBody": "The proxy runs as a single Bun process on your machine or fleet. Credentials never leave your infrastructure. Request bodies are never logged.",
  "landing.terminal.eyebrow": "In the terminal",
  "landing.terminal.meta": "session · local",
  "landing.terminal.proxyListening": "opencodex 2.7.1 · proxy listening on http://localhost:8317",
  ...
  "landing.how.oneBody": "Install OpenCodex, then run ocx. The dashboard opens on a local port with the proxy already listening.",
  "landing.how.twoTitle": "Add your providers",
  "landing.how.twoBody": "Sign in with OAuth or paste API keys. OpenCodex validates each account and learns its models, limits and latency profile.",
  "landing.how.threeTitle": "Point your tools at it",
  "landing.how.threeBody": "Set one base URL in Codex CLI, the desktop app or your SDK. Routing, failover and usage accounting happen behind it.",
  "landing.pricing.eyebrow": "Pricing",
  "landing.pricing.title": "Free, as in MIT",
  "landing.pricing.forever": "/ forever",
  "landing.pricing.body": "The full proxy, dashboard and every provider adapter. Self-hosted, no account required, no usage caps from us. Your providers' limits are the only limits.",
