...
export const ru: Record<TKey, string> = {
  ...
  "claudeDesktop.subtitle": "Направляйте каждое семейство моделей Claude через доступную модель на порту {port}.",
  ...
  "claudeDesktop.importReady": "JSON импортирован. Проверьте черновик, затем сохраните и примените его.",
  ...
  "claudeDesktop.emptyHint": "Добавьте или включите провайдера, затем вернитесь, чтобы назначить маршруты Claude Desktop.",
  ...
  "claudeDesktop.laneEmpty": "Перетащите модель сюда или используйте элемент перемещения.",
  ...
  "claudeDesktop.useAsDefault": "Использовать как модель по умолчанию для {family}",
