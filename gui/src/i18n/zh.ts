...
export const zh: Record<TKey, string> = {
  ...
  "dash.retry": "重试",
  "dash.fresh": "已更新 · {time}",
  "dash.noContactSince": "自 {time} 起无响应",
  "dash.modelsCount": "{count} 个模型",
  "dash.showModels": "显示模型",
  "dash.hideModels": "隐藏模型",
  "dash.stamp.ready": "就绪",
  "dash.stamp.busy": "运行中",
  "dash.stamp.error": "错误",
  "dash.stamp.idle": "空闲",
  "dash.settingsSection": "设置",
  "dash.emptyKitchen": "暂无模型。",
  "dash.providerDisabled": "已停用",
  ...
  "prov.accounts": "账户（{n}）",
  "prov.quotaRefresh": "刷新用量",
  "prov.quotaRefreshing": "正在刷新…",
  "prov.quotaRefreshFailed": "刷新失败 — 显示最近一次数据",
  "prov.quotaRefreshAria": "刷新 {name} 的用量",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "shell.navSystem": "系统",
  "shell.navAria": "主导航",
  "shell.offlineBanner": "代理离线。Codex 和 Cursor 无法路由。",
  "mod.subtitle": "目录、路由和子代理委派。",
  "mod.tablistAria": "模型分区",
  "sys.manage": "管理",
  "sys.subtitle": "代理本身:状态、版本、存储和管理。",
  "sys.proxy": "代理",
  "sys.uptime": "已运行 {uptime}",
  "sys.updateTo": "更新到 {version}",
  "sys.upToDate": "你正在使用最新版本。",
  "sys.updateCheckFailed": "更新检查失败",
  "sys.updateStartFailed": "启动更新失败",
  "sys.updateRunning": "更新进行中。代理稍后会自行重启。",
  "sys.catalog": "模型目录",
  "sys.catalogDesc": "同步会从每个提供方获取最新模型。",
  "sys.syncFailed": "同步失败",
  "sys.storage": "存储",
  "sys.storageValue": "{size} · {count} 个文件",
  "sys.apiEndpoint": "API 端点",
  "sys.copy": "复制",
  "sys.copied": "已复制",
  "sys.codexAuthDesc": "openai 提供方的 ChatGPT 账户池",
  "sys.claudeCodeDesc": "Claude 集成与代理注入",
  "sys.dangerZone": "危险区域",
  "sys.stopDesc": "完全停止代理。Codex 和 Cursor 将失去连接。",
  "sys.stopConfirmTitle": "停止代理？",
  "sys.stopConfirmDesc": "Codex 和 Cursor 将失去连接。",
  "sys.keepRunning": "保持运行",
  "vk.subtitle": "经过代理的一切:每个请求都是一张小票。",
  "vk.statsAria": "流量数据",
  "vk.tokens30d": "令牌 (30天)",
  "vk.requestsToday": "今日请求",
  "vk.requests30d": "请求 (30天)",
  "vk.filterAria": "按提供方筛选",
  "vk.all": "全部",
  "vk.pause": "暂停",
  "vk.follow": "实时跟随",
  "vk.loadFailed": "无法加载流量。保留最后已知的小票。",
  "vk.empty": "今天还没有流量。",
  "vk.showAnalysis": "完整分析",
  "vk.hideAnalysis": "隐藏分析",
  "vk.stampDone": "完成",
  "vk.stampError": "错误",
  "vk.stampBusy": "进行中",
