...
export const IconBoxes = (p: P) => (
  <svg {...S(p)}>
    <path d="M12 2 4 6v6l8 4 8-4V6l-8-4Z" />
    <path d="m4 6 8 4 8-4M12 10v8" />
  </svg>
);
...
export const IconHardDrive = (p: P) => (
  <svg {...S(p)}>
    <path d="M22 12H2" />
...
export const IconKey = (p: P) => (
  <svg {...S(p)}>
    ...
    <path d="m10.7 12.3 9.6-9.6M16 7l3 3M14 9l2 2" />
  </svg>
);
