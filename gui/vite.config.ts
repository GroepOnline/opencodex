...
export default defineConfig({
  ...
  build: { rollupOptions: { output: { manualChunks(id) { if (id.includes('src/pages/Usage')) return 'usage'; if (id.includes('src/pages/Verkeer')) return 'verkeer'; if (id.includes('src/pages/Dashboard')) return 'dashboard'; } } } },
  /* [Decision Log]
