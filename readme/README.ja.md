...
```bash
npm install -g --allow-scripts=bun @groeponline/opencodex   # --ignore-scripts, --omit=optional なしで
...
現在のディレクトリを再インストールしてしまいます。常に `@groeponline/opencodex` を明示してください。
